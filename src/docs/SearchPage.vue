  ...
  <container>
    ...
    <row>
      ...
      <column md="6">
        <form class="form-inline mt-4 mb-4">
          <fa-icon aria-hidden="true" icon="search"></fa-icon>
          <input class="form-control form-control-sm ml-3 w-75" type="text" placeholder="Search" aria-label="Search" />
        </form>
    ...
    <div class="input-group md-form form-sm form-1 pl-0">
      <div class="input-group-prepend">
        <span class="input-group-text purple lighten-3" id="basic-text1"><fa-icon aria-hidden="true" class="text-white" icon="search"></fa-icon></span>
      </div>
      <input class="form-control my-0 py-1" type="text" placeholder="Search" aria-label="Search" />
    </div>
    <div class="input-group md-form form-sm form-1 pl-0">
      <div class="input-group-prepend">
        <span class="input-group-text cyan lighten-2" id="basic-text1"><fa-icon aria-hidden="true" class="text-white" icon="search"></fa-icon></span>
      </div>
      <input class="form-control my-0 py-1" type="text" placeholder="Search" aria-label="Search" />
    </div>
    <div class="input-group md-form form-sm form-1 pl-0">
      <div class="input-group-prepend">
        <span class="input-group-text pink lighten-3" id="basic-text1"><fa-icon aria-hidden="true" class="text-white" icon="search"></fa-icon></span>
      </div>
      <input class="form-control my-0 py-1" type="text" placeholder="Search" aria-label="Search" />
    </div>
    <div class="input-group md-form form-sm form-2 pl-0">
      ...
      <div class="input-group-append">
        <span class="input-group-text amber lighten-3" id="basic-text1"><fa-icon aria-hidden="true" class="grey-text" icon="search"></fa-icon></span>
      </div>
    </div>
    <div class="input-group md-form form-sm form-2 pl-0">
      <input class="form-control my-0 py-1 lime-border" type="text" placeholder="Search" aria-label="Search" />
      <div class="input-group-append">
        <span class="input-group-text lime lighten-2" id="basic-text1"><fa-icon aria-hidden="true" class="grey-text" icon="search"></fa-icon></span>
      </div>
    </div>
    <div class="input-group md-form form-sm form-2 pl-0">
      <input class="form-control my-0 py-1 red-border" type="text" placeholder="Search" aria-label="Search" />
      <div class="input-group-append">
        <span class="input-group-text red lighten-3" id="basic-text1"><fa-icon aria-hidden="true" class="grey-text" icon="search"></fa-icon></span>
      </div>
    </div>
  </container>
</template>
...
<script>
import { Column, Container, FormInline, MdInput, Row } from 'mdbvue';
...
.active-cyan svg, .active-cyan-2 svg {
  color: #4dd0e1 !important;
}
.active-purple svg, .active-purple-2 svg {
  color: #ce93d8 !important;
}
.active-pink svg, .active-pink-2 svg {
...
.active-cyan-3 svg, .active-cyan-4 svg {
  color: #4dd0e1;
}
.active-purple-3 svg, .active-purple-4 svg {
  color: #ce93d8;
}
.active-pink-3 svg, .active-pink-4 svg {
  color: #f48fb1;
}
